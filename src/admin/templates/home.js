...
export function renderHome() {
  return layout({
    ...
    <div class="grid gap-4">
      <a href="/admin/audio-exercises" class="block bg-slate-800 border border-slate-700 rounded-xl p-6 no-underline text-inherit transition-colors hover:border-blue-500">
